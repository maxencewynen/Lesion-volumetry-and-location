...
$ANTs_registration -d 3 -n 4 -f $FLAIR -m $MPRAGE -t r -o $TRANSFORMATIONS/sub-${SUBJECT}/ses-${SESSION}/sub-${SUBJECT}_MPRAGE_normalized

rm $TRANSFORMATIONS/sub-${SUBJECT}/ses-${SESSION}/sub-${SUBJECT}_MPRAGE_normalizedInverseWarped.nii.gz
mv $TRANSFORMATIONS/sub-${SUBJECT}/ses-${SESSION}/sub-${SUBJECT}_MPRAGE_normalizedWarped.nii.gz $TRANSFORMATIONS/sub-${SUBJECT}/ses-${SESSION}/sub-${SUBJECT}_MPRAGE_normalized.nii.gz
#mv $ANAT_DIR/sub-${SUBJECT}_MPRAGE_normalized0GenericAffine.mat $ANAT_DIR/sub-${SUBJECT}_MPRAGE_to_FLAIR.mat
rm $TRANSFORMATIONS/sub-${SUBJECT}/ses-${SESSION}/sub-${SUBJECT}_MPRAGE_normalized0GenericAffine.mat
